...
function gresham_kernel!(price, pi, beta0, beta1, Nsim, Titer, alpha, rho, sigmap, sigmaf, sigmab, delta, sce)
...
pp=plot(plot1, plot2, plot3, plot4, layout=(2, 2))
savefig(pp,"gresham_results.png")