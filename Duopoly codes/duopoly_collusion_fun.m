function [p_collude1,p_collude2,br, profit]=duopoly_collusion_fun(N,lambda,wn)
% Model parameters
%N = 10000;
...
for t = 1:N-1
    ...
    br(1,t)=(beta1(1,t)+ beta1(3,t)*alpha1(1,t)) / (2*(beta1(2,t) - beta1(3,t)*alpha1(2,t)));
    br(2,t)=(beta2(1,t)+ beta2(3,t)*alpha2(1,t)) / (2*(beta2(2,t) - beta2(3,t)*alpha2(2,t)));
    ...
    q1 = max(0,beta1(1,t) - beta1(2,t)*p(1,t) + beta1(3,t)*p(2,t));
    q2 = max(0,beta2(1,t) - beta2(2,t)*p(2,t) + beta2(3,t)*p(1,t));
    ...
    alpha1(:,t+1)=alpha1(:,t)+lambda*inv(R1)*[1; p(1,t)]*(p(2,t)-alpha1(1,t)-alpha1(2,t)*p(1,t));
    ...
    alpha2(:,t+1)=alpha2(:,t)+lambda*inv(R2)*[1; p(2,t)]*(p(1,t)-alpha2(1,t)-alpha2(2,t)*p(2,t));
